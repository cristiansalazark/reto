...
public class ControladorQuadbike {
    ...
    @GetMapping("/{id}")
    public Optional<Quadbike> getQuadbike(@PathVariable("id") int cabinId) {
        return servicio.getQuadbike(cabinId);
    }

    @PostMapping("/save")
    @ResponseStatus(HttpStatus.CREATED)
    public Quadbike save(@RequestBody Quadbike cabin) {
        return servicio.save(cabin);
    }
    @PutMapping("/update")
    @ResponseStatus(HttpStatus.CREATED)
    public Quadbike update(@RequestBody Quadbike cabin) {
